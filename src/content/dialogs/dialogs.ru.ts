...
export const dialogsRu: MultilineContent = {
  ...
  [Content.STAGE_1_FORGOT_TO_CLICK]: `
    ...
    Когда только начинаешь пользоваться ботом - такое бывает не редко.${NL}
    Главное приучить себя и довести всё до конца.
  `,
  ...
  [Content.BOT_IGNORE]: `
    ...
    1. ${B}{{from_scratch_message}}${B} - для тех кто долго не пользовался ботом.${NL}
    Сбросит вас до начала, чтобы вы начали ${I}всё с нуля${I}.${N2}
    2. ${B}{{no_penalty_message}}${B} - просто продолжим.${NL}
    Ваше время будет ${B}{{ no_penalty_time }}${B}${N2}
    3. ${B}{{penalty_10_message}}${B} - если вы сбились с графика, лучше сделать минимальный откат на 10 минут.${NL}
    Ваше время будет ${B}{{ penalty_10_time }}${B}
  `,
