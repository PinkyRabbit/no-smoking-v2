...
export const dialogsRu: MultilineContent = {
  ...
  [Content.WINSTRIKE_BASE_FAILED]: `
    ⭐️ Вы на ${B}тренировочном${B} уровне сложности.${NL}
    ✨${I}Штрафные баллы не учитываются.${I}✨${N2}
    Это нужно для того, чтобы вам было проще разобраться в том, как работает бот.${N2}
    Всё же, постарайтесь продержаться без штрафов в следующий раз 😉
  `,
  ...
  [Content.DIFFICULTY]: `
    ...
    Текущий уровень сложности - ${B}{{difficulty}}${B}${N2}
