...
export const dialogsRu: MultilineContent = {
  ...
  [Content.STAGE_2_IGNORE_MIN]: `
    ...
    Минимальный интервал для учёта составляет {{min_interval}}.${NL}
    В современных телефонах такое может происходить не по вине пользователя.
    Это очень раздражает - мы понимаем.${NL}
    Для того чтобы этого избежать - ${B}закрывайте диалог с ботом, как только увидели время${B}.
  `,
