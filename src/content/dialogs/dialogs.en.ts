...
export const dialogsEn: MultilineContent = {
  ...
  [Content.BOT_IGNORE_FAILED]: DEFAULT,
  [Content.BOT_IGNORE_SUCCESS]: DEFAULT,
  [Content.STATS]: DEFAULT,
  [Content.HOW]: DEFAULT,
  [Content.PENALTY_3]: DEFAULT,
  [Content.IDLE_NO_CIGARETTES]: DEFAULT,
  [Content.MAXIMUM_REACHED]: DEFAULT,
  // dev
