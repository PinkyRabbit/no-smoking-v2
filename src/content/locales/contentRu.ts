...
export const contentRu: MultilineContent = {
  ...
  [Content.STAGE_1_IGNORE_MAX]: `
    Вы слишком часто нажимаете на кнопку.${N2}
    Минимальный интервал для учёта составляет {{max_stage_1}}.${ND}
    💢 осталось {{stage_1_left}} раз
  `,
  ...
  [Content.STAGE_1_END]: `
    ...
    Поздравляем Вас!${N2}
    Благодаря вашему упорству, мы смогли высчитать среднее время, с которого мы можем начать.
    Оно составляет ${B}{{hours}}${B} часов, ${B}{{minutes}}${B} минут.${ND}
