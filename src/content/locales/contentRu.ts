...
export const contentRu: MultilineContent = {
  ...
  [Content.TIMEZONE_SELECTED]: `
    Настройки можно изменить её в любой момент, написав /timezone${ND}
    🕰️ Выбрана временная зона: ${B}{{timezone}}${B}
  `,
  [Content.SETTINGS]: `
    🔮 Нужно завершить настройку вашего аккаунта
  `,
