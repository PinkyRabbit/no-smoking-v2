...
import { NL, N2, ND, B } from "./constants";
...
export const contentRu: MultilineContent = {
  ...
  [Content.START_EXISTING]: `
    ...
    Тогда ты ${B}начнёшь с этапа 1${B}.${N2} 
    2. Очистить прогресс.${NL}
    Ты ${B}начнёшь с этапа 2${B}, но начальное время сбросится.${N2} 
    3. Оставить как есть.${NL}
    Ты продолжаешь с момента, как оставил аккаунт. ${B}Не рекомендуется${B}.${N2} 
  `,
  [Content.START_EXISTING_STAGE_1]: `
    Привет! ✌️${N2}
    Мы видим что ты уже сделал некоторый прогресс в нашем приложении.${N2}
